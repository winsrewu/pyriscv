...
riscv32-unknown-elf-gcc -g -static -specs=nosys.specs -march=rv32im -mabi=ilp32 -T ../c-common/link.ld -o app.elf ../c-common/vectors.S ../c-common/syscalls.c main.c -lc -lgcc
